    ...
    categories: [
      {
        label: "",
        entries: [
          { slug: "introduction", title: "Introduction", desc: "What Optimistic is, why it exists, and what's inside.", built: true },
          { slug: "principles", title: "How to Use", desc: "Where to start, how the system fits together, and the rules that keep it coherent.", built: true },
          { slug: "colors", title: "Color System", desc: "A monochrome field with one warm accent. Roles, scales and contrast guarantees.", built: true },
          { slug: "typography", title: "Typography", desc: "Inter for reading, Inter Display for headlines, mono for the machine's voice.", built: true },
          { slug: "spacing", title: "Spacing", desc: "A 4px base scale and the rhythm rules that keep sections breathing evenly.", built: true },
          { slug: "grid", title: "Grid System", desc: "Columns, gutters and the 1320px container every page hangs from.", built: true },
          { slug: "elevation", title: "Elevation", desc: "Depth without drama: hairlines first, shadows only where meaning needs them.", built: true },
          { slug: "radius", title: "Border Radius", desc: "From sharp panels to rounded chips, and when each is the right call.", built: true },
          { slug: "breakpoints", title: "Breakpoints", desc: "The widths where layouts reflow, and how components adapt across them.", built: true },
        ],
      },
    ],
  },
    ...
    categories: [
      ...
      },
      {
        ...
        entries: [
          ...
          { slug: "notification", title: "Notification", desc: "System messages with severity, action and dismissal.", built: true },
      ...
      },
      {
        ...
        entries: [
          ...
          { slug: "icon", title: "Icon", desc: "~2,000 single-colour line icons from Lucide, searchable.", built: true },
          { slug: "illustration", title: "Illustration", desc: "20 single-colour line scenes for empty, error and success states.", built: true },
          { slug: "gridcomp", title: "Grid", desc: "Layout primitives for composing responsive regions.", built: true },
          { slug: "codeblock", title: "Code Block", desc: "Source shown honestly: mono, copyable, highlighted.", built: true },
        ],
      },
    ],
  },
